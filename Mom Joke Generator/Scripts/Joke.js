...
function ShowJoke()
{
    const randomElement = yoMamaJokes[Math.floor(Math.random() * yoMamaJokes.length)];
    HidePopUp('Load');
    ShowPopUp("Text", "block")
    ShowPopUp("Button", "flex")
    ChangeInnerText("Text", randomElement)
